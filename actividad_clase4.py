...
for numero in lista_numeros:
    if (numero % 2 == 0):
        suma_pares.append(numero)
    else :
        suma_impares.append(numero)

for numero in suma_pares:
    sumatoria_pares=sumatoria_pares+numero

for numero in suma_impares:
    sumatoria_impares=sumatoria_impares+numero

print(sumatoria_pares+sumatoria_impares)
...
mi_lista=[]
for numero in range(3,301,3):mi_lista.append(numero)
...
for numero in range(1,16):
    suma_numeros=numero ** 2
    suma_cuadrados=suma_cuadrados+suma_numeros
...
for item,nombre in enumerate(lista_nombres):
    print(f'{nombre} se encuentra en el índice {item}')
...
for indice,nombre in enumerate(lista_nombres):
    if "M" in nombre :
        print(f"posicion {indice} , corresponde al nombre {nombre}") 
